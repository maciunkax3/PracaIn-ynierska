...
%\includepdf{StronaTytulowa_155170.pdf}
%\includepdf{Oswiadczenie_155170.pdf}
\input{meta/tytulowa.tex}
\newpage
...
\input{rozdzialy/8-rozdzial.tex} \newpage
...
%\input{dodatki/przykladowy_dodatek.tex} \newpage
\end{appendices}
